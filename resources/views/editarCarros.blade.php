...
<div class="row center">
  <div class="col">
    <input type="text" class="form-control" placeholder="Digite a Marca do Carros" aria-label="First name">
  </div>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{route('alterar-carros',$registrosCarros->id)}}">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
      ...
      <td>
        <form method="Post" Action="{{route('apagar-carros',$registrosCarros->id)}}">
          @method('delete')
          @csrf
          <input type="hidden" name="id"value="{{$registrosCarros->id}}">
