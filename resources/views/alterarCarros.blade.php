...
<section>
  <div class="container cadastroCaminhao">
    <form class="row g-3" method="post" action="{{route('alterar-banco-carros',$registrosCarros->id)}}">
      @csrf
      @method('put')
      <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <input type="text" name="cor"value="{{old('cor',$registrosCarros->cor)}}" class="form-control" id="inputCor" placeholder="Preto">
        @error('cor')
